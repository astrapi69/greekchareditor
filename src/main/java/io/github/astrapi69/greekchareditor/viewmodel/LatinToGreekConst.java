...
public interface LatinToGreekConst
{
	...
	public static final String LATIN_K_JIOTA_DIALYTIKA = ":I"; // "CAPITAL LETTER IOTA WITH
																// DIALYTIKA"
	...
	public static final String LATIN_M_JIOTA_TONOS_DIALYTIKA = ":_i"; // "SMALL LETTER IOTA WITH
																		// DIALYTIKA AND TONOS"
	...
	public static final String LATIN_K_YPSILON_DIALYTIKA = ":Y"; // "CAPITAL LETTER UPSILON WITH
																	// DIALYTIKA"
	...
	public static final String LATIN_M_YPSILON_DIALYTIKA = ":y"; // "SMALL LETTER UPSILON WITH
																	// DIALYTIKA"
	/** SMALL LETTER YPSILON WITH DIALYTIKA AND TONOS in Latin. value:":_y" */
	public static final String LATIN_M_YPSILON_TONOS_DIALYTIKA = ":_y"; // "SMALL LETTER UPSILON
	...
	public static final String[] greekAlphabet_LATIN = { LATIN_K_ALPHA, LATIN_K_ALPHA_TONOS,
			LATIN_M_ALPHA, LATIN_M_ALPHA_TONOS, LATIN_K_BETA, LATIN_M_BETA, LATIN_K_GAMMA,
			LATIN_M_GAMMA, LATIN_K_DELTA, LATIN_M_DELTA, LATIN_K_EPSILON, LATIN_K_EPSILON_TONOS,
			LATIN_M_EPSILON, LATIN_M_EPSILON_TONOS, LATIN_K_ZETA, LATIN_M_ZETA, LATIN_K_HTA,
			LATIN_K_HTA_TONOS, LATIN_M_HTA, LATIN_M_HTA_TONOS, LATIN_K_THETA, LATIN_M_THETA,
			LATIN_K_JIOTA, LATIN_K_JIOTA_TONOS, LATIN_K_JIOTA_DIALYTIKA, LATIN_M_JIOTA,
			LATIN_M_JIOTA_TONOS, LATIN_M_JIOTA_DIALYTIKA, LATIN_M_JIOTA_TONOS_DIALYTIKA,
			LATIN_K_KAPPA, LATIN_M_KAPPA, LATIN_K_LAMDA, LATIN_M_LAMDA, LATIN_K_MI, LATIN_M_MI,
			LATIN_K_NI, LATIN_M_NI, LATIN_K_KSI, LATIN_M_KSI, LATIN_K_OMIKRON,
			...
			LATIN_M_TAF, LATIN_K_YPSILON, LATIN_K_YPSILON_TONOS, LATIN_K_YPSILON_DIALYTIKA,
			LATIN_M_YPSILON, LATIN_M_YPSILON_TONOS, LATIN_M_YPSILON_DIALYTIKA,
			LATIN_M_YPSILON_TONOS_DIALYTIKA, LATIN_K_FI, LATIN_M_FI, LATIN_K_XI, LATIN_M_XI,
			LATIN_K_PSI, LATIN_M_PSI, LATIN_K_OMEGA, LATIN_K_OMEGA_TONOS, LATIN_M_OMEGA,
			LATIN_M_OMEGA_TONOS };

	public static final List<String> GREEK_ALPHABET_AS_LIST = Arrays.asList(greekAlphabet_LATIN);

	public static final String[][] greekAlphabetLATIN = { { "A" }, // "CAPITAL_LETTER_ALPHA"
