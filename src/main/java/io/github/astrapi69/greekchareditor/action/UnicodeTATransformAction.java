...
public class UnicodeTATransformAction extends AbstractAction implements Constants
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try
		{
			transformUnicodeCharacters(textAreaInput, textAreaPreview, textAreaHtmlEntitys,
	 ...
	 */
	private void transformUnicodeCharacters(JTextArea textAreaInput, JTextArea textAreaPreview,
