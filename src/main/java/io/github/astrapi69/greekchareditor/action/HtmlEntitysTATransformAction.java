...
public class HtmlEntitysTATransformAction extends AbstractAction implements Constants
{
	...
	public HtmlEntitysTATransformAction(String name)
	{
		...
		this.htmlEntitys2ISO_8859_7 = GreekAlphabetUtil.getHtmlEntitys2ISO_8859_7();
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		transformHtmlEntities(textAreaInput, textAreaPreview, textAreaHtmlEntitys,
	 ...
	 */
	private void transformHtmlEntities(JTextArea textAreaInput, JTextArea textAreaPreview,
		...
		for (int i = 0; i < length; i++)
		{
			...
			if (current == '&')
			{
				...
				if (entity.charAt(1) == '#')
				{
					...
					{
						outputLatinChars.append(htmlEntitys2Latin.getProperty(entity));
						outputGreekChars.append(htmlEntitys2Greek.getProperty(entity));
